...
<body class="flat-blue sidebar-collapse">
	...
	<div class="content-container">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<span class="page-title red"><h3>学校更改</h3>
					</span>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="content-block">
						<div class="block-title">学生</div>
						<form action="studentModify" method="post" class="form-vertical"
							enctype="">
							<div class="block-content">
										...
										<c:choose>
											<c:when test="${sessionScope['admin']['agid'] == 0 }">
												<c:forEach items="${grades }" var="grade">
													<option value="${grade['gid'] }" <c:if test="${grade['gid'] == student['sgid'] }">selected="selected"</c:if>>${grade['gname']
														}</option>
												</c:forEach>
											</c:when>
											<c:otherwise>
								...
								<div class="form-group">
									<label for="exampleInputPassword1">学号</label> <input
										name="snumber" type="text" class="form-control"
										id="exampleInputPassword1" placeholder="请输入标题" value="${student['snumber'] }"> 
										<input name="sid" type="hidden" class="form-control"
										id="exampleInputPassword1" placeholder="请输入来源" value="${student['sid'] }">
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">密码</label> <input
										name="spwd" type="text" class="form-control"
										id="exampleInputPassword1" placeholder="请输入来源" value="${student['spwd'] }">
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">姓名</label> <input
										name="sname" type="text" class="form-control"
										id="exampleInputPassword1" placeholder="请输入来源" value="${student['sname'] }">
								</div>
							</div>
